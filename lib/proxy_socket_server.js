...
ProxySocketServer.prototype._register_server_connection = function (socket) {
  ...
  this._clients_io.emit('new server', socket_info);
...
ProxySocketServer.prototype._get_info_about_servers = function () {
  return this._servers_io.clients().map(this._get_socket_info.bind(this));
};
...
ProxySocketServer.prototype._register_client_connection = function (socket) {
  ...
  socket.emit('available servers', {
    servers: this._get_info_about_servers()
  });
