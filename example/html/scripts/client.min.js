...
define("ofio/ofio", [], function () {
  var e = function (e, t) {
    ...
    console && console[t || "log"]("Ofio: " + e)
  }, r = function (e) {
    return e = e || {}, this.new_class = this.create_class(), this.parent_class = null, this.modules = {}, this.namespaces = {}, this.included = {}, this.prepare_modules(e.modules), this.extend(e.extend), this.include_modules(), this.new_class.prototype.init = function () {
    }, this.new_class
  };
  r.prototype.create_class = function () {
    var e = this, n = function (n) {
      return Object.defineProperty(this, "options", {enumerable: !1, configurable: !1, writable: !1, value: t(n)}), e.init_class(this)
    };
    return n.ofio = this, n
  }, r.prototype.prepare_modules = function (e) {
    Array.prototype.forEach.call(e || [], function (e) {
      e instanceof r.Module && (this.modules[e.config.name] = e)
    }, this)
  }, r.prototype.extend = function (n) {
    if (typeof n != "function")return;
    this.parent_class = n;
    var r = function () {
    };
    r.prototype = n.prototype, this.new_class.prototype = new r, this.new_class.prototype.constructor = this.new_class, this.new_class.parent = n.prototype, typeof n.ofio == "object" && (this.modules = e(t(n.ofio.modules), this.modules), this.namespaces = t(n.ofio.namespaces))
  }, r.prototype.include_modules = function (e) {
    e = e || this.modules;
    var t = this.included, r = this.parent_class && this.parent_class.ofio, i = r && r.modules || {}, s = this.new_class.prototype;
    for (var o in e) {
      if (t[o])continue;
      t[o] = !0;
      var u = this.modules[o] = e[o];
      this.include_modules(u.config.dependencies);
      if (!i[o]) {
        var a = u.config.namespace;
        if (a) {
          var f = this.namespaces[a] = function (e) {
            this.parent = e
          };
          f.prototype = u
        } else for (var l in u) {
          if (l == "init")continue;
          s[l] !== undefined && n("A property " + l + " has redefined by module " + u.config.name + "!", "warn"), s[l] = u[l]
        }
      }
      u.config.on_include.call(this.new_class.prototype, this.new_class)
    }
  }, r.prototype.init_class = function (e) {
    return this.init_modules(e), e.init && e.init() || e
  }, r.prototype.init_modules = function (e, t, n) {
    t = t || this.modules, n = n || {};
    for (var r in t) {
      if (n[r])continue;
      n[r] = !0;
      var i = t[r];
      this.init_modules(e, i.config.dependencies, n);
      var s = e, o = i.config.namespace;
      o && (s = e[o] = new this.namespaces[o](e)), i.init.call(s)
    }
  };
  var i = r.Module = new r;
  return i.prototype.init = function () {
    Object.defineProperty(this, "config", {enumerable: !1, configurable: !1, writable: !1, value: {name: "", dependencies: {}, namespace: "", on_include: function () {
    }}}), e(this.config, this.options);
    var t = {};
    Array.prototype.forEach.call(this.config.dependencies || [], function (e) {
      e instanceof r.Module && (t[e.config.name] = e)
    }), this.config.dependencies = t
  }, r
}), function () {
...
}), define("ofio/ofio.id", ["ofio/ofio"], function (e) {
  var t = new e.Module({name: "ofio.id"}), n = 0;
  return t.init = function () {
    this.id = n++
  }, t.equal = function (e) {
    return e && this.id === e.id
  }, t
}), define("ofio/ofio.logger", ["ofio/ofio"], function (e) {
  if (!window.console) {
    var t = function () {
      return arguments
    };
    window.console = {error: t, log: t, info: t, warn: t, trace: t, group: t, groupEnd: t}
  }
  var n = new e.Module({name: "ofio.logger"});
  return n.log = function (e, t, n) {
    n && (e = "[Module: " + n.config.name + "] " + e), console[t || "log"].call(console, e)
  }, n
}), function (e, t) {
  function P(e) {
...
}(window), define("vendor/jquery.min", function () {
}), define("ofio/ofio.jquery", ["ofio/ofio", "ofio/ofio.id", "ofio/ofio.logger", "vendor/jquery.min"], function (e) {
  var t = new e.Module({name: "ofio.jquery", dependencies: arguments}), n = /^(\S+)\s*(.*)$/;
  return t.init = function () {
    !this.options.$el && !this.options.el ? this.$el = $(this.render()) : this.$el = this.options.$el || $(this.options.el), this.el = this.$el[0], this.el || this.log("`el` is undefined", "warn", t), this.delegate_events()
  }, t.$ = function () {
    return this.$el.find.apply(this.$el, arguments)
  }, t.render = function () {
    return""
  }, t.delegate_events = function (e) {
    e = e || (typeof this.events == "function" ? this.events() : this.events);
    if (!e)return;
    this.undelegate_events();
    for (var t in e) {
      var r = e[t];
      typeof r == "string" && (r = this[r]);
      if (typeof r != "function")throw new Error('Method "' + t + '" does not exist');
      var i = t.match(n), s = i[1], o = i[2];
      r = r.bind(this), s += ".delegate_events" + this.id, o === "" ? this.$el.on(s, r) : o == "window" ? $(window).on(s, r) : o == "document" ? $(document).on(s, r) : this.$el.on(s, o, r)
    }
  }, t.undelegate_events = function () {
    this.$el.off(".delegate_events" + this.id)
  }, t
}), define("Form", ["ofio/ofio", "_", "ofio/ofio.jquery"], function (e) {
  var t = new e({modules: arguments});
  return t.prototype.classes = {log: "log"}, t.prototype.events = {submit: "_submit"}, t.prototype.init = function () {
    this._server_id = this.options.id, this._socket = this.options.socket, this._$log = this.$("." + this.classes.log), this._$input = this.$('input[type="text"]'), this.$el.appendTo("body")
  }, t.prototype._template = _.template('<form class="server_form"><input type="text"/><input type="submit"/><div class="<%= log %>"></div></form>'), t.prototype._message_template = _.template('<div class="log_message"></div>'), t.prototype.render = function () {
    return this._template(this.classes)
  }, t.prototype.log_data = function (e) {
    var t = $(this._message_template());
    t.text(e.text).appendTo(this._$log)
  }, t.prototype._submit = function (e) {
    e.preventDefault(), this._socket.emit("data", {to: this._server_id, text: this._$input.val()}), this._$input.val("")
  }, t.prototype.destruct = function () {
    this.$el.remove()
  }, t
}), define("FormsManager", ["ofio/ofio", "Form", "ofio/ofio.jquery"], function (e, t) {
  var n = new e({modules: arguments});
  return n.prototype.init = function () {
    this._socket = this.options.socket, this._forms = {}, this._$no_servers = $("<div>No servers are available</div>").appendTo(this.$el), this._servers_exists(!1)
  }, n.prototype.create_forms = function (e) {
    e.forEach(this.create_form.bind(this))
  }, n.prototype.create_form = function (e) {
    this._forms[e] = new t({id: e, socket: this._socket}), this._servers_exists(!0)
  }, n.prototype.remove_forms = function (e) {
    e.forEach(this.remove_form.bind(this))
  }, n.prototype.remove_form = function (e) {
    var t = this.get_by_id(e);
    t && (t.destruct(), delete this._forms[e]), Object.keys(this._forms).length || this._servers_exists(!1)
  }, n.prototype.get_by_id = function (e) {
    return this._forms[e]
  }, n.prototype._servers_exists = function (e) {
    this._$no_servers.toggle(!e)
  }, n
});
...
(function () {
  (function (e, t) {
    ...
    n.version = "0.9.11", n.protocol = 1, n.transports = [], n.j = [], n.sockets = {}, n.connect = function (e, r) {
      ...
      var u = {host: i.host, secure: "https" == i.protocol, port: i.port || ("https" == i.protocol ? 443 : 80), query: i.query || ""};
      n.util.merge(u, r);
    ...
    function r(e) {
      this.options = {port: 80, secure: !1, document: "document"in n ? document : !1, resource: "socket.io", transports: t.transports, "connect timeout": 1e4, "try multiple transports": !0, reconnect: !0, "reconnection delay": 500, "reconnection limit": Infinity, "reopen delay": 3e3, "max reconnection attempts": 10, "sync disconnect on unload": !1, "auto connect": !0, "flash policy port": 10843, manualFlush: !1}, t.util.merge(this.options, e), this.connected = !1, this.open = !1, this.connecting = !1, this.reconnecting = !1, this.namespaces = {}, this.buffer = [], this.doBuffer = !1;
    ...
    e.SocketNamespace = n, t.util.mixin(n, t.EventEmitter), n.prototype.$emit = t.EventEmitter.prototype.emit, n.prototype.of = function () {
      ...
      switch (e.type) {
        ...
        case"json":
          ...
          e.ack == "data" ? i.push(r) : e.ack && this.packet({type: "ack", ackId: e.id}), this.$emit.apply(this, i);
          break;
        case"event":
  ...
  }("undefined" != typeof io ? io.Transport : module.exports, "undefined" != typeof io ? io : module.parent.exports, this), typeof define == "function" && define.amd && define("io", [], function () {
    return io
  })
...
}), requirejs.config({baseUrl: "./scripts", paths: {vendor: "../../../vendor", ofio: "../../../vendor/ofio", io: "../../../vendor/socket.io.min", _: "../../../vendor/underscore-min"}, shim: {io: {exports: "io"}, _: {exports: "_"}}}), requirejs(["FormsManager", "io", "shim"], function (e, t) {
  var n = t.connect("http://82.166.192.202:10843/as_client"), r = new e({socket: n, el: document.body});
  n.on("available servers", function (e) {
    r.create_forms(e.ids)
  }), n.on("new server", function (e) {
    r.create_form(e.id)
  }), n.on("servers disconnected", function (e) {
    r.remove_forms(e.ids)
  }), n.on("error", function (e) {
    console.error(e.message)
  }), n.on("data", function (e) {
    var t = r.get_by_id(e.from);
    t.log_data(e)
  })
